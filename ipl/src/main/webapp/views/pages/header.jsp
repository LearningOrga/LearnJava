...
<p class = "centerAlign">Hello, <b><%=session.getAttribute("loginName") %></b>. Welcome to Predict and Win - Season 2020 <br></br> Total Points Remaining : <b><%=session.getAttribute("totalRemainingPoints") %></p>
